...
<head>
	<!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>AMovie-Single page</title>
            ...
            <div class="col-sm-12">
                ...
                <div class="post">
                        ...
                        <div class="swiper-container">
                          <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide" data-text='Aliquam cursus porta porttitor. Donec faucibus risus vitae porta tincidunt.'> 
                                 <img alt='' src="images/new/news-2.jpg">
                              </div>
                    ...
                    <div class="post__images post__images--right col-sm-6 pull-right">
                        <img alt='' src="images/client-photo/post-img1.jpg">
                    </div>
                    ...
                    <div class="post__images post__images--left col-sm-6 pull-left">
                        <img alt='' src="images/client-photo/post-img2.jpg">
                    </div>
