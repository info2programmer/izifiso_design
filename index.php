            ...
            <div class="banner">
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" class="slide" data-slide='Rush.'>
                        <img alt='' src="images/slides/first-slide.png">
                        ...
                        <div class="caption slide__time margin-slider sfr str" data-x="right" data-hoffset='-243'
                            data-y="186" data-speed="300" data-start="2100" data-easing="easeOutBack" data-endspeed="300"
                            data-end="8700" data-endeasing="Back.easeIn">
                            From
                        </div>
                        <div class="caption slide__date margin-slider lfb ltb" data-x="right" data-hoffset='-149'
                            data-y="186" data-speed="500" data-start="2400" data-easing="Power4.easeOut" data-endspeed="400"
...
Create trip film.'>
                        ...
                        <div class="caption slide__name slide__name--smaller" data-x="left" data-y="160" data-splitin="chars"
                            data-elementdelay="0.1" data-speed="700" data-start="1400" data-easing="easeOutBack"
                            data-customin="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:0;transformOrigin:50% 50%;"
                            data-frames="{ typ :lines;
                                                 elementdelay :0.1;
                        ...
                        <div class="caption slide__date position-center postion-place--two lfb ltb" data-x="left"
                            data-y="242" data-speed="500" data-start="2400" data-easing="Power4.easeOut" data-endspeed="400"
                            data-endeasing="Back.easeIn">
                            April 18
                        </div>
                        ...
                        <div class="caption slide__date position-center postion-place--four lfb ltb" data-x="left"
                            data-y="242" data-speed="500" data-start="2800" data-easing="Power4.easeOut" data-endspeed="400"
                            data-endeasing="Back.easeIn">
                            May 01
                        </div>

                        <div class="caption lfb slider-wrap-btn ltb" data-x="left" data-y="310" data-speed="400"
                            data-start="3300" data-easing="Power4.easeOut" data-endspeed="500" data-endeasing="Power4.easeOut">
...
Start doing.'>
                        <img alt='' src="images/slides/next-slide.png">
                        <div class="caption slide__name slide__name--smaller slide__name--specific customin customout"
                            data-x="left" data-y="160" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
                            data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                            data-speed="700" data-start="1400" data-easing="easeOutBack" data-endspeed="500" data-end="8600"
                            data-endeasing="Back.easeIn">
                        ...
                        <div class="caption lfb customout slider-wrap-btn" data-x="left" data-y="310" data-speed="500"
                            data-start="2800" data-easing="Power4.easeOut" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
        ...
        <section class="container">
            <div class="movie-best">
                <div class="col-sm-10 col-sm-offset-1 movie-best__rating">Your Next Gateway</div>
                ...
                <div class="mega-select-present mega-select-top mega-select--full">
                    <div class="mega-select-marker">
                        <div class="marker-indecator location">
                            <p class="select-marker"><span>Where will</span> <br> you go next?</p>
                        </div>
                        ...
                        <div class="marker-indecator film-category">
                            <p class="select-marker"><span>Which will </span> <br> you choose?</p>
                        </div>
                    ...
                    <div class="mega-select pull-right">
                        ...
                        <div class="select__btn">
                            <a href="#" class="btn btn-md btn--danger location">find <span class="hidden-exrtasm">By Location</span></a>
                            <a href="#" class="btn btn-md btn--danger cinema">find <span class="hidden-exrtasm">suitable
                                    cimema</span></a>
                            <a href="#" class="btn btn-md btn--danger film-category">find <span class="hidden-exrtasm">best
                                    category</span></a>
                            <a href="#" class="btn btn-md btn--danger actors">find <span class="hidden-exrtasm">talented
                                    actors</span></a>
                            <a href="#" class="btn btn-md btn--danger director">find <span class="hidden-exrtasm">favorite
                                    director</span></a>
                            <a href="#" class="btn btn-md btn--danger country">find <span class="hidden-exrtasm">produced
                                    country</span></a>
                        </div>
            ...
            <h2 id='target' class="page-heading heading--outcontainer">WHAT'S NEW</h2>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="movie movie--test movie--test--light movie--test--left">
                            <div class="movie__images">
                                <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="images/mousuni-villa.png">
                                </a>
                            </div>

                            <div class="movie__info">
                                <a href='movie-page-left.html' class="movie__title">Mousuni Villa</a>

                                <p class="movie__time"><a href="https://www.google.com/maps/place/Doladanga+Backpackers'+Camp+(izifiso)/@22.9646193,86.7079918,17z/data=!3m1!4b1!4m5!3m4!1s0x39f6387941450d37:0xe58885188d7661be!8m2!3d22.9646193!4d86.7101805"
                                        target="_blank">Beach Camp</a></p>
                        ...
                        <div class="movie movie--test movie--test--light movie--test--left">
                            <div class="movie__images">
                                <a href="movie-page-left.html" class="movie-beta__link">
                                    <img alt='' src="images/mathaburu-hostel.png">
                                </a>
                            </div>

                            <div class="movie__info">
                                <a href='movie-page-left.html' class="movie__title">Mathaburu Trail </a>

                                <p class="movie__time"><a href="https://www.google.com/maps/place/Doladanga+Backpackers'+Camp+(izifiso)/@22.9646193,86.7079918,17z/data=!3m1!4b1!4m5!3m4!1s0x39f6387941450d37:0xe58885188d7661be!8m2!3d22.9646193!4d86.7101805"
                                        target="_blank">Experience Night Camping</a></p>
                        ...
                        <div class="row">
                            <div class="social-group">
                                <div class="col-sm-12">
                                    <div class="social-group__head">About Us</div>
                                    <h3>“I read; I travel; I become” ― Derek Walcott</h3>
                                   <p> Izifiso is not only a company, but a journey, the journey that started in March, 2017. Keeping in mind the meaning of the word in original Zulu language, Izifiso had come up with its exciting tagline: “Where desires get wings.”</p>

<p> The most beautiful things in life are perhaps moments-accentuated with wilderness and the desires of the heart. Nothing can surpass the beauty of a sunset dipping in the melancholic melody of country music. The beauty that surrounds us - the nature that surrounds us just needs to be explored and harnessed, to turn it to a lifetime experience and we at Izifiso give wings to these unharnessed desires of the heart.</p>

<p> Mousuni Backpackers’ Camp was Izifiso’s first venture, which was set up in November, 2017. From then, the number got expanded to seven backpackers’ camps at different parts of West Bengal and Izifiso is eyeing something more.</p>

<p>But our focus is just not to set up camps or organize treks, but to think differently about travel. So, come with us, travel away from home, feel the goose bumps break into the skin in the eerie night, sweat under the scorching sun on an uphill trek, dance in the twilight sands to the waves that crash on the shore, whisper to the mangroves, gape at the constellations and let the mountain winds lull you to sleep. Let all these be a part of your story and your life and let them turn you into a story teller. We at Izifiso, aim at offering such off-beat travel experiences by making travel a venture to the dreamland.</p>

<p>Explore, educate and evolve.</p>

                                </div>
                                <div class="col-sm-12">
                                    <div class="content-wrapper">
                                        <div class="social-group__head">Testimonials</div>

                                        <div class="col-sm-6 col-md-4">
                                            <div class="testionaial">
                                                <div class="testionaial__images">
                                                    <img alt="" src="images/client-photo/thumb1.jpg">
                                                </div>
                                                <p class="testionaial__author">Tamara Walsh</p>
                                                <p class="testionaial__organization">Themeforest, CEO</p>

                                                <div class="testionaial__text">“Fusce nec libero odio. Nam quis cursus
                                                    nisi. Nam adipiscing dictum ante. Nam adipiscing dictum ante. Sed
                                                    tincidunt libero sit amet ante molestie eu. Aliquam eu elit sit
                                                    amet augue condimentum imperdiet non eget odio.”</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="testionaial">
