...
<div class="banner-top">
            <img alt='top banner' src="images/banners/upper-tab.png" alt="Izifiso - Where desire get wings">
        </div>
                ...
                <nav id="navigation-box">
                    ...
                    <ul id="navigation">
                        ...
                        <li>
                            ...
                            <a href="#">Blog</a>
                            <ul>
                                <li class="menu__nav-item"><a href="blog.php">Category one</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category two</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category three</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category four</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category five</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category six</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Category four</a></li>
                                <li class="menu__nav-item"><a href="blog.php">Cinemas list</a></li>
                            </ul>
                        </li>
                        <!-- <li>
                ...
                <div class="control-panel">
                    <div class="auth auth--home">
                        ...
                        <ul class="auth__function">
                            <li><a href="#" class="auth__function-item">Account</a></li>
                            <li><a href="#" class="auth__function-item">Booking History</a></li>
                            <li><a href="#" class="auth__function-item">Notifications</a></li>
                            <li><a href="#" class="auth__function-item">Logout</a></li>
                        </ul>

                    </div>
                    <a href="#" class="btn btn-md btn--warning btn--book btn-control--home login-window">Account</a>
                </div>
