...
<head>
	<!-- Basic Page Needs -->
        <meta charset="utf-8">
        <title>Backpackes' Hostel</title>
        <meta name="description" content="Like villa, backpackers’ hostel is another new initiative of Izifiso. This is the perfect option for a friendly traveler who always wants to make pals. Because, here one has the option to share room with an unknown person, perhaps.">
...
<body> 
    ...
    <?php include_once('includes/header.php'); ?>
        ...
        <section class="container">
            <div class="col-sm-12">
                <h1 class="page-heading">Our Backpackers' Hostel</h1>
                ...
                <div class="movie movie--preview movie--full comments">
                     <div class="col-sm-3 col-md-2 col-lg-2">
                            <div class="movie__images">
                                <img alt='' src="images/movie/3.png">
                            </div>
